...
export const HR_EMPLOYEES: HREmployee[] = [
  ...
  { id: "e09", workspace_id: W, employee_number: "EMP-1009", full_name: "Tamer Hosny", full_name_ar: "تامر حسني", phone: "+20-188-999-0000", email: "tamer.h@bumblebee.com", department: "delivery", job_title: "Delivery Driver", job_title_ar: "سائق توصيل", employment_type: "full_time", status: "active", hire_date: d(300), contract_end_date: d(60), salary: 7000, salary_type: "monthly", branch: "10th Ramadan", manager_id: "e05", manager_name: "Omar Salah", address: "Marg, Cairo", emergency_contact: "Hosny Tamer", emergency_phone: "+20-188-111-2222", avatar_color: "#F97316", skills: [{ skill: "driving", level: 5 }], leave_balance: 6, attendance_risk: "medium", probation_end_date: null, last_review_date: d(60), next_review_date: d(-30), performance_score: 74, documents: [{ name: "Employment Contract", type: "contract", uploaded_at: d(300) }, { name: "Driving License", type: "permit", uploaded_at: d(300) }], equipment: [{ item: "Delivery Van", assigned_at: d(300), status: "assigned" }, { item: "Samsung Phone", assigned_at: d(300), status: "assigned" }], metadata: {} },
  ...
  { id: "e19", workspace_id: W, employee_number: "EMP-1019", full_name: "Mariam Hassan", full_name_ar: "مريم حسن", phone: "+20-109-000-1111", email: "mariam.h@bumblebee.com", department: "sales", job_title: "Senior Sales Associate", job_title_ar: "مندوبة مبيعات أولى", employment_type: "full_time", status: "active", hire_date: d(650), contract_end_date: null, salary: 13000, salary_type: "monthly", branch: "Nasr City", manager_id: "e02", manager_name: "Sara Mahmoud", address: "Nasr City, Cairo", emergency_contact: "Hassan Mariam", emergency_phone: "+20-109-222-3333", avatar_color: "#DC2626", skills: [{ skill: "supervision", level: 3 }], leave_balance: 14, attendance_risk: "medium", probation_end_date: null, last_review_date: d(10), next_review_date: d(-80), performance_score: 86, documents: [{ name: "Employment Contract", type: "contract", uploaded_at: d(650) }], equipment: [{ item: "iPhone 14", assigned_at: d(650), status: "assigned" }], metadata: {} },
