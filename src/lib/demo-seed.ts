...
export const DEMO_SITE_VISITS: T<"site_visits">[] = [
  ...
  },
  {
    ...
    preferred_style: "classic", special_notes: "Client budget ~150K EGP total",
...
export const DEMO_COST_ENTRIES: T<"cost_entries">[] = [
  { id: "ce-01", workspace_id: W, sales_order_id: null, production_order_id: "po-01", cost_type: "material", description: "White MDF 18mm sheets x18", quantity: 18, unit_cost: 120, total_cost: 2160, currency: "EGP", date: d(30), supplier: "Saudi MDF Co.", notes: null, metadata: {}, created_at: ts(30), updated_at: ts(30) },
  { id: "ce-02", workspace_id: W, sales_order_id: null, production_order_id: "po-01", cost_type: "material", description: "White Lacquer MDF sheets x10", quantity: 10, unit_cost: 180, total_cost: 1800, currency: "EGP", date: d(30), supplier: "Saudi MDF Co.", notes: null, metadata: {}, created_at: ts(30), updated_at: ts(30) },
  { id: "ce-03", workspace_id: W, sales_order_id: null, production_order_id: "po-01", cost_type: "material", description: "HPL Grey Countertop 30mm", quantity: 1, unit_cost: 850, total_cost: 850, currency: "EGP", date: d(29), supplier: "Al-Qahtani Surfaces", notes: null, metadata: {}, created_at: ts(29), updated_at: ts(29) },
  { id: "ce-04", workspace_id: W, sales_order_id: null, production_order_id: "po-01", cost_type: "hardware", description: "Blum Tip-On hinges", quantity: 28, unit_cost: 22, total_cost: 616, currency: "EGP", date: d(28), supplier: "Blum KSA", notes: null, metadata: {}, created_at: ts(28), updated_at: ts(28) },
  { id: "ce-05", workspace_id: W, sales_order_id: null, production_order_id: "po-01", cost_type: "hardware", description: "Soft-close drawer slides", quantity: 12, unit_cost: 45, total_cost: 540, currency: "EGP", date: d(28), supplier: "Blum KSA", notes: null, metadata: {}, created_at: ts(28), updated_at: ts(28) },
  { id: "ce-06", workspace_id: W, sales_order_id: null, production_order_id: "po-01", cost_type: "labor", description: "CNC programming & setup", quantity: 1, unit_cost: 500, total_cost: 500, currency: "EGP", date: d(27), supplier: null, notes: null, metadata: {}, created_at: ts(27), updated_at: ts(27) },
  { id: "ce-07", workspace_id: W, sales_order_id: null, production_order_id: "po-02", cost_type: "material", description: "White MDF 18mm sheets x12", quantity: 12, unit_cost: 120, total_cost: 1440, currency: "EGP", date: d(28), supplier: "Saudi MDF Co.", notes: null, metadata: {}, created_at: ts(28), updated_at: ts(28) },
  { id: "ce-08", workspace_id: W, sales_order_id: null, production_order_id: "po-02", cost_type: "hardware", description: "Sliding door tracks + rollers x3", quantity: 3, unit_cost: 350, total_cost: 1050, currency: "EGP", date: d(25), supplier: "Hafele KSA", notes: "Delivery delayed 3 days", metadata: {}, created_at: ts(25), updated_at: ts(25) },
  { id: "ce-09", workspace_id: W, sales_order_id: null, production_order_id: "po-03", cost_type: "material", description: "Walnut Veneer MDF 18mm", quantity: 8, unit_cost: 280, total_cost: 2240, currency: "EGP", date: d(14), supplier: "Premium Wood KSA", notes: null, metadata: {}, created_at: ts(14), updated_at: ts(14) },
  { id: "ce-10", workspace_id: W, sales_order_id: null, production_order_id: "po-03", cost_type: "material", description: "Corian Glacier White fabrication", quantity: 4, unit_cost: 800, total_cost: 3200, currency: "EGP", date: d(12), supplier: "Corian Fabricators", notes: "External fabrication — 10 day lead", metadata: {}, created_at: ts(12), updated_at: ts(12) },
  { id: "ce-11", workspace_id: W, sales_order_id: null, production_order_id: "po-05", cost_type: "material", description: "Kitchen material bundle", quantity: 1, unit_cost: 4500, total_cost: 4500, currency: "EGP", date: d(58), supplier: "Saudi MDF Co.", notes: null, metadata: {}, created_at: ts(58), updated_at: ts(58) },
  { id: "ce-12", workspace_id: W, sales_order_id: null, production_order_id: "po-05", cost_type: "hardware", description: "Hardware bundle (hinges, slides, handles)", quantity: 1, unit_cost: 2200, total_cost: 2200, currency: "EGP", date: d(55), supplier: "Blum KSA", notes: null, metadata: {}, created_at: ts(55), updated_at: ts(55) },
];
...
export const DEMO_QUOTATIONS: T<"work_items">[] = [
  {
    ...
    metadata: {
      ...
      transport_cost: 1500, installation_cost: 4000, currency: "EGP",
      converted_to: "so-01",
    },
  ...
  },
  {
    ...
    metadata: {
      ...
      transport_cost: 2000, installation_cost: 5000, currency: "EGP",
    },
  ...
  },
  {
    ...
    metadata: {
      ...
      transport_cost: 3000, installation_cost: 9000, currency: "EGP",
    },
  ...
  },
  {
    ...
    metadata: {
      ...
      transport_cost: 3500, installation_cost: 2500, currency: "EGP",
    },
...
export const DEMO_PURCHASE_ITEMS: T<"work_items">[] = [
  {
    ...
    metadata: {
      ...
      estimated_amount: 720, department: "production", currency: "EGP",
  ...
  },
  {
    ...
    metadata: {
      ...
      estimated_amount: 1400, department: "production", currency: "EGP",
      delivery_date: d(-3),
    },
  ...
  },
  {
    ...
    metadata: {
      ...
      estimated_amount: 3200, department: "production", currency: "EGP",
  ...
  },
  {
    ...
    metadata: {
      ...
      estimated_amount: 3960, department: "production", currency: "EGP",
      delivery_date: d(28),
    },
  ...
  },
  {
    ...
    metadata: {
      ...
      estimated_amount: 1156, department: "production", currency: "EGP",
      delivery_date: d(27),
    },
  ...
  },
  {
    ...
    metadata: {
      ...
      estimated_amount: 1050, department: "production", currency: "EGP",
      delivery_date: d(1),
    },
