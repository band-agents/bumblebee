 ...
 *
 * This one sits *inside* the shell. The rail, header and Buzz keep working;
        ...
        <div className="bb-card max-w-xl w-full mt-10 p-7">
          <div className="flex items-start gap-3.5">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-title font-semibold mb-1" style={{ fontFamily: "var(--app-font-serif)" }}>
              ...
              <p className="text-body text-muted-foreground mb-5">
                {ar
                  ...
                  : "The problem is contained to this page — the rest of Bumblebee is still running. Try it again, or move somewhere else and come back."}
              </p>
