...
export const STATUS_META: Record<Status, { en: string; ar: string; dot: string; pill: string }> = {
  ...
  lead:     { en: "Lead",     ar: "محتمل",    dot: "bg-primary",     pill: "bg-primary/8 text-brand-ink border border-primary/20" },
...
export const PEOPLE: Person[] = [
  // ── p01: Omar — rich profile ──────────────────────────
  {
    ...
    activity: [
      ...
      {
        id: "a07", kind: "added",
        textEn: "Contact added to Bumblebee",
        textAr: "تمت إضافة جهة الاتصال إلى بامبلبي",
  ...
  {
    id: "p07", name: "Nour Al-Haddad", nameAr: "نور الحداد", company: "Bumblebee", companyAr: "بامبلبي",
    ...
    phone: "+971 50 112 3344", email: "nour@bumblebee.io",
    city: "Dubai", cityAr: "دبي", country: "UAE", countryAr: "الإمارات",
  ...
  {
    id: "p08", name: "Tariq Nassar", nameAr: "طارق نصار", company: "Bumblebee", companyAr: "بامبلبي",
    ...
    phone: "+971 55 667 8899", email: "tariq@bumblebee.io",
    city: "Dubai", cityAr: "دبي", country: "UAE", countryAr: "الإمارات",
  ...
  {
    id: "p09", name: "Rana Khalil", nameAr: "رنا خليل", company: "Bumblebee", companyAr: "بامبلبي",
  ...
  {
    id: "p10", name: "Hassan Younis", nameAr: "حسن يونس", company: "Bumblebee", companyAr: "بامبلبي",
    ...
    phone: "+971 56 334 5566", email: "hassan@bumblebee.io",
    city: "Dubai", cityAr: "دبي", country: "UAE", countryAr: "الإمارات",
    lastContactEn: "2 days ago", lastContactAr: "منذ يومين", avatarColor: "bg-warning/15 text-warning",
