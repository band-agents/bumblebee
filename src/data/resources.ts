...
export function fmtVal(value: number, currency: string = "EGP", locale: string = "en-EG"): string {
...
const DEFAULT_RESOURCES: Resource[] = [
  {
    ...
    value: 450000, currency: "EGP", utilization: 87,
    ...
    maintenance: [
      { id: "m1", titleEn: "Spindle bearing replacement", titleAr: "استبدال محمل المغزل", status: "completed", dateEn: "Jul 15, 2025", dateAr: "١٥ يوليو ٢٠٢٥", costEn: "EGP 12,000", costAr: "١٢,٠٠٠ ج.م" },
  ...
  },
  {
    ...
    value: 180000, currency: "EGP", utilization: 0,
    purchaseDateEn: "Mar 2021", purchaseDateAr: "مارس ٢٠٢١",
    maintenance: [
      { id: "m3", titleEn: "Motor replacement", titleAr: "استبدال المحرك", status: "overdue", dateEn: "Aug 1, 2025", dateAr: "١ أغسطس ٢٠٢٥", costEn: "EGP 25,000", costAr: "٢٥,٠٠٠ ج.م" },
    ],
  },
  {
    ...
    value: 220000, currency: "EGP", utilization: 72,
  ...
  },
  {
    ...
    value: 340000, currency: "EGP", utilization: 65,
  ...
  },
  {
    ...
    value: 96000, currency: "EGP", utilization: 82, relatedWorkId: "w-008",
  ...
  },
  {
    ...
    value: 1200000, currency: "EGP", utilization: 60,
    purchaseDateEn: "Feb 2020", purchaseDateAr: "فبراير ٢٠٢٠",
    maintenance: [
      { id: "m5", titleEn: "HVAC service", titleAr: "خدمة تكييف", status: "completed", dateEn: "Jul 28, 2025", dateAr: "٢٨ يوليو ٢٠٢٥", costEn: "EGP 3,500", costAr: "٣,٥٠٠ ج.م" },
  ...
  },
  {
    ...
    value: 800000, currency: "EGP", utilization: 78,
    purchaseDateEn: "Jan 2019", purchaseDateAr: "يناير ٢٠١٩",
    maintenance: [
      { id: "m7", titleEn: "AC unit replacement — Unit 3", titleAr: "استبدال وحدة تكييف — الوحدة ٣", status: "overdue", dateEn: "Aug 3, 2025", dateAr: "٣ أغسطس ٢٠٢٥", costEn: "EGP 18,000", costAr: "١٨,٠٠٠ ج.م" },
    ],
  },
  {
    ...
    value: 15000, currency: "EGP", utilization: 100,
    purchaseDateEn: "Jan 2025", purchaseDateAr: "يناير ٢٠٢٥",
    maintenance: [{ id: "m8", titleEn: "License renewal", titleAr: "تجديد الرخصة", status: "upcoming", dateEn: "Dec 1, 2025", dateAr: "١ ديسمبر ٢٠٢٥", costEn: "EGP 15,000", costAr: "١٥,٠٠٠ ج.م" }],
  },
  {
    ...
    value: 95000, currency: "EGP", utilization: 55,
    purchaseDateEn: "Aug 2023", purchaseDateAr: "أغسطس ٢٠٢٣",
    maintenance: [{ id: "m9", titleEn: "Battery replacement", titleAr: "استبدال البطارية", status: "upcoming", dateEn: "Sep 15, 2025", dateAr: "١٥ سبتمبر ٢٠٢٥", costEn: "EGP 8,000", costAr: "٨,٠٠٠ ج.م" }],
  },
  {
    ...
    ownerEn: "Logistics Team", ownerAr: "فريق اللوجستيات",
    locationEn: "Dubai Warehouse", locationAr: "مستودع دبي",
    value: 85000, currency: "EGP", utilization: 0,
  ...
  },
  {
    ...
    ownerEn: "Production Line A", ownerAr: "خط الإنتاج أ",
    locationEn: "Riyadh Plant, Store A", locationAr: "مصنع الرياض، مخزن أ",
    value: 72000, currency: "EGP", utilization: 70,
  ...
  },
  {
    ...
    value: 35000, currency: "EGP", utilization: 0,
