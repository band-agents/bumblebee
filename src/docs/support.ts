...
export const ISSUES: Issue[] = [
  ...
  { slug: "missing-menu", area: "Access", symptom: "A module is missing from my sidebar",
    cause: "Your role, or the modules your admin picked for you, don't include it.", fix: ["Ask an admin to open your panel in Users & Access and set that module to View or Work. It appears within seconds."], link: "users-and-access" },
  { slug: "view-only-save", area: "Access", symptom: "Saving is refused in a module I can open", message: "Your access to this module doesn't allow this change. Ask an admin for Work access.",
    cause: "You have View access to that module, which can read but not add or change.", fix: ["Ask an admin to set the module to Work on your panel in Users & Access."], link: "users-and-access" },
  ...
  { slug: "no-finance-invoice", area: "Access", symptom: "Create invoice or Record payment isn't there", message: "Your access doesn't include Finance, so you can't issue invoices or receipts",
    cause: "Issuing invoices and receipts needs Work access to Finance.", fix: ["Ask an admin to give you Finance access, or ask a finance colleague to issue it."], link: "roles" },
