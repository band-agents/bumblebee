...
export const ARTICLES: Article[] = [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: "table", head: ["Area", "Status"], rows: [
            ...
            ["Users & Access (logins, module access, suspend, remove), Team, Employees", "Live"],
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: "p", text: "If an admin suspends or removes your login, you're signed out within seconds and the sign-in page tells you why. A suspended login can't sign in until the admin chooses **Re-activate**." },
        ],
      },
    ],
  ...
  // ───────────────────────── People ─────────────────────────
  {
    ...
    summary: "Create a login for each colleague, choose exactly which modules they can open, and suspend or remove logins.",
    status: "live",
    sections: [
      {
        id: "page",
        ...
        blocks: [
          { t: "p", text: "Lists every member with role, department, status (**Active** or **Suspended**), last sign-in and how many modules they can open. A **Custom** tag means you picked their modules yourself instead of using the role's. Tabs: **Overview**, **Members** and **Roles**." },
        ],
      },
      {
        id: "create",
      ...
      {
        id: "modules",
        heading: "Choose exactly what someone can open",
        blocks: [
          { t: "steps", items: [
      ...
      {
        id: "suspend",
        heading: "Suspend a login",
        blocks: [
          { t: "steps", items: [
            "Open the member's panel and choose **Suspend & sign out**.",
            "Within a few seconds they're signed out on every device — computer, phone, any open tab — and land on the sign-in page with a note that an admin suspended their login.",
            "They can't sign in again while suspended, and the database returns no workspace data to that login.",
            "To bring them back, choose **Re-activate**. They sign in with the same username and password.",
          ] },
          { t: "p", text: "Nothing they created is deleted or changed." },
        ],
      },
      {
        id: "remove",
        heading: "Remove a login for good",
        blocks: [
          { t: "steps", items: [
            "Open the member's panel and choose **Remove login**.",
            "Confirm with **Yes, remove …**.",
          ] },
          { t: "list", items: [
            "They're taken out of the workspace and signed out of every device.",
            "The login can never be used again, and their username becomes free for a new login.",
            "Everything they created — orders, invoices, stock movements — stays, still showing who made it.",
            "This can't be undone. To give them access again later, create a new login.",
          ] },
          { t: "note", tone: "tip", text: "Not sure yet? **Suspend** instead — it's reversible." },
        ],
      },
      {
        id: "rules",
        heading: "Who can manage whom",
        blocks: [
          { t: "table", head: ["Who can…", "Owner", "Admin", "Others"], rows: [
            ["Create normal logins", "✓", "✓", "—"],
            ["Create owner or admin logins", "✓", "—", "—"],
            ["Change access, suspend, reset password or remove a normal member", "✓", "✓", "—"],
            ["Do the same to an admin", "✓", "—", "—"],
            ["Change or remove the owner", "—", "—", "—"],
            ["Change their own access or remove themselves", "—", "—", "—"],
          ] },
        ],
      },
    ],
