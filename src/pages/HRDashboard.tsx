    ...
    <div className="min-h-full px-6 md:px-8 py-6 max-w-[1440px] mx-auto space-y-6">
        ...
        <div className="flex items-center gap-2">
          {[
            ...
            <button
              ...
              className="h-9 px-4 rounded-xl border border-border/60 text-micro font-medium text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-all duration-200 flex items-center gap-1.5"
            >
              <btn.icon size={12} />
              {btn.label}
            </button>
      ...
      <motion.div variants={cardV} custom={2} initial="hidden" animate="visible">
        <div className="flex items-center gap-2 flex-wrap">
          <span className="text-micro font-medium text-muted-foreground mr-1">
          ...
          {[
            ...
            <button
              ...
              className={`h-8 px-3.5 rounded-xl border text-micro font-medium flex items-center gap-1.5 transition-all duration-200 ${action.color}`}
            >
              <action.icon size={12} />
              {action.label}
            </button>
        ...
        >
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            {[
              ...
              { label: ar ? "متأخر" : "Late", value: lateToday, color: "text-warning", bg: "bg-warning/10" },
              ...
              <div key={i} className={`${s.bg} rounded-xl p-3 text-center`}>
                <p
                  className={`text-heading font-bold ${s.color}`}
                  style={serif}
                >
                  {s.value}
                </p>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center justify-between mt-1">
              <span className="text-micro text-emerald-600 font-medium">
                {todayAttendance.length > 0
            ...
            {todayAttendance
              ...
              .map((a) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-6 h-6 rounded-full flex items-center justify-center text-micro font-bold text-white shrink-0"
          ...
          <div className="space-y-2">
            {HR_LEAVES.filter((l) => l.status === "pending").map((leave) => {
              ...
              return (
                ...
                >
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center text-micro font-bold text-white shrink-0"
                    style={{ backgroundColor: emp.avatar_color }}
                  >
                    {emp.full_name
                      .split(" ")
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-micro text-muted-foreground/70 mt-0.5 line-clamp-1">
                      {leave.reason}
                    </p>
                  </div>
                  <div className="flex gap-1.5 shrink-0">
                    <button className="text-micro text-emerald-600 px-2.5 py-1.5 rounded-lg border border-emerald-200 hover:bg-emerald-50 transition-colors font-medium">
                      {ar ? "موافقة" : "Approve"}
                    </button>
                    <button className="text-micro text-rose-600 px-2.5 py-1.5 rounded-lg border border-rose-200 hover:bg-rose-50 transition-colors font-medium">
                      {ar ? "رفض" : "Reject"}
                    </button>
                  </div>
                </motion.div>
                ...
                <div key={event.id} className="flex gap-3 py-2 relative">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-micro">
                      {emp && (
                        <span
                          className="font-medium text-brand-ink cursor-pointer hover:underline"
                          onClick={() =>
